	...
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="game.email.batchadd">
		 ...
		 <shiro:hasPermission name="game.email.name">
            <li class="active"><a href="${ctx}/tools/gameEmail/batchNameAdd"><spring:message code='str1162'/>(<spring:message code='str653'/>)</a></li>
        </shiro:hasPermission>
	</ul>
	<br />
	<form:form id="inputForm" modelAttribute="gameEmail"
		enctype="multipart/form-data"
		action="${ctx}/tools/gameEmail/batchNameSave" method="post"
