...
<html>
<head>
	<title><spring:message code='str1480'/>ID<spring:message code='str1473'/></title>
...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="game.recharge.apply">
			...
			<li  class="active"><a href="${ctx}/tools/recharge/roleIdRechargeForm?id=${recharge.id}"><c:if test="${ not empty recharge.id}"><spring:message code='str1480'/>ID<spring:message code='str1158'/></c:if><c:if test="${  empty recharge.id}"><spring:message code='str1480'/>ID<spring:message code='str1365'/></c:if><spring:message code='str547'/></a></li>
		</shiro:hasPermission>
	</ul><br/>
    <div class="alert alert-info">
        ...
        <spring:message code='str171'/>2<spring:message code='str1511'/>
    </div>
	...
	<form:form id="inputForm" modelAttribute="recharge" action="${ctx}/tools/recharge/save" method="post" class="form-horizontal">
        ...
        <div class="control-group">
            <label class="control-label"><spring:message code='str138'/>ID:</label>
            <div class="controls">
