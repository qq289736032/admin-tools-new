...
<head>
	...
	<script type="text/javascript">
		function page(n,s){
	            $("#pageNo").val(n);
	            $("#pageSize").val(s);
	            $("#searchForm").attr("action","${ctx}/game/activityJoin/caiLiaoFuBenList");
	            $("#searchForm").submit();
	            return false;
	    }
	</script>
...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/game/activityJoin/caiLiaoFuBenList"><spring:message code='cailiaofuben'/></a></li><!-- 活动参与度列表 -->
	...
	<form id="searchForm" action="${ctx}/game/activityJoin/activityJoinList" method="post" class="breadcrumb form-search">
				...
				<div class="" style="width:100%;height:300px;line-height:300px;overflow:scroll;">
					<table id="contentTable" class="table table-striped table-bordered table-condensed  ">
						<tr>
							...
							<th><spring:message code='chongzhicishu'/></th>
						</tr>
