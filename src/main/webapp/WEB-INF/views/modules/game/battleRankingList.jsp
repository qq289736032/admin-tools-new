...
<html>
<head>
	<title><spring:message code='str1'/></title>
	<meta name="decorator" content="default"/>
</head>
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/game/role/battleRanking/"><spring:message code='str1'/></a></li>
	</ul>
	<form id="searchForm" action="${ctx}/game/role/battleRanking" method="post" class="breadcrumb form-search">
		...
		&nbsp;<input id="btnSubmit" class="btn btn-primary" type="submit" value="<spring:message code="operation.search"/>" onclick="return page();"/>
	     <input id="btnExport" class="btn btn-primary" type="button" value="<spring:message code='str5'/>" onclick="exportXls('${ctx}/game/role/exportXls')"/>
	</form>
	<tags:message content="${message}"/>
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<tr>
		<th><spring:message code='str6'/></th>
		<th><spring:message code='str7'/></th>
		<th><spring:message code='str8'/></th>
		<th><spring:message code='str11'/></th></tr>
