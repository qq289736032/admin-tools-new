...
<html>
<head>
	<title><spring:message code='str342'/></title>
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/global/rechargeConsume/monthBindConsumeReport"><spring:message code='str343'/></a></li>
	</ul>
...
<div class="row-fluid">
			<div class="span12 panel panel-primary">
				<div class="panel-heading"><spring:message code='str345'/></div>
				...
				<table id="dailyTable1" class="table table-striped table-bordered table-condensed">
					<tr><th><spring:message code='str198'/></th><th><spring:message code='str234'/></th><th><spring:message code='str201'/></th><th><spring:message code='str346'/></th><th><spring:message code='str347'/></th><th><spring:message code='str217'/></th><th><spring:message code='str200'/></th><th><spring:message code='str348'/></th><th><spring:message code='str349'/></th><th><spring:message code='str262'/></th><th><spring:message code='str254'/></th><th><spring:message code='str205'/></th><th>ARPU</th><th><spring:message code='str220'/>ARPU</th><th><spring:message code='str265'/></th><th><spring:message code='str266'/></th></tr>
				...
				<div class="" style="width:100%;height:300px;line-height:300px;overflow:auto;ovoverflow:scrolld="dailyTable2" class="table table-striped table-bordered table-condensed">
					...
					<c:forEach items="${monthList}" var="item">
						<tr>
							...
							<td <c:if test="${item.month_new_pay_rate > 1 }">style="color: red;font-weight:bold" </c:if>><fmt:formatNumber value="${item.month_new_arpu}" pattern="0.00"/></td>
		...
		<div class="row-fluid">
			<div class="span6 panel panel-primary">
				<div class="panel-heading"><spring:message code='str362'/></div>
