...
<html>
<head>
	<title><spring:message code='str436'/></title>
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/global/tradeController/propSale?stype=1"><spring:message code='str436'/></a></li>
	</ul>
	...
	<table id="active-yb" class="table table-striped table-bordered table-condensed">
		<tr><th><spring:message code='str187'/></th><th><spring:message code='str437'/></th><th><spring:message code='str438'/></th><th><spring:message code='str439'/>ID</th><th><spring:message code='str440'/></th><th><spring:message code='str441'/></th><th><spring:message code='str226'/>(%)</th>
			<th><spring:message code='str442'/></th><th><spring:message code='str191'/></th><th><spring:message code='str262'/></th><th><spring:message code='str443'/></th><th><spring:message code='str444'/></th><th><spring:message code='str445'/></th></tr>
