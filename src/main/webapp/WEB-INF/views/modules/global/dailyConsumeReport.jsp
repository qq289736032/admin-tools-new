...
<html>
<head>
	<title><spring:message code='str295'/></title>
	<meta name="decorator" content="default"/>
	<%@include file="/WEB-INF/views/include/highcharts.jsp" %>
</head>
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/global/rechargeConsume/dailyConsumeReport"><spring:message code='str295'/></a></li>
	</ul>
...
<div class="row-fluid">
			<div class="span12 panel panel-primary">
				...
				<table id="dailyTable" class="table table-striped table-bordered table-condensed">
					<tr><th><spring:message code='str198'/></th><th><spring:message code='str234'/></th><th><spring:message code='str254'/></th><th><spring:message code='str199'/></th><th><spring:message code='str200'/></th><th><spring:message code='str191'/></th><th><spring:message code='str262'/></th><th><spring:message code='str263'/></th><th><spring:message code='str264'/>ARPU</th><th><spring:message code='str220'/>ARPU</th><th><spring:message code='str265'/></th><th><spring:message code='str266'/></th></tr>
					<c:forEach items="${dailyList}" var="item">
						<tr>
							...
							<td><fmt:formatNumber value="${item.first_amount/100}" pattern="0.00"/></td>
						</tr>
					</c:forEach>
				</table>
				</div>
				...
				<table id="dailyTable" class="table table-striped table-bordered table-condensed">
					...
					<c:forEach items="${dailyList}" var="item">
						<tr>
							...
							<td><fmt:formatNumber value="${item.first_day_amount/100}" pattern="0.00"/></td>
							...
							<td><fmt:formatNumber value="${item.third_day_amount/100}" pattern="0.00"/></td>
							...
							<td><fmt:formatNumber value="${item.seventh_day_amount/100}" pattern="0.00"/></td>
							...
							<td>${item.nn_num}</td>
							<td><fmt:formatNumber value="${item.nn_amount/100}" pattern="0.00"/></td>
							...
							<td>${item.on_num}</td>
							<td><fmt:formatNumber value="${item.on_amount/100}" pattern="0.00"/></td>
							...
							<td>${item.oo_num}</td>
							<td><fmt:formatNumber value="${item.oo_amount/100}" pattern="0.00"/></td>
		...
		<div class="row-fluid">
			<div class="span6 panel panel-primary">
				...
				<table id="dailyTable3" class="table table-striped table-bordered table-condensed">
					<tr><th><spring:message code='str198'/></th><th><spring:message code='str56'/></th><th><spring:message code='str223'/></th><th><spring:message code='str191'/></th><th><spring:message code='str254'/></th><th><spring:message code='str263'/></th><th><spring:message code='str264'/>APRU</th><th><spring:message code='str220'/>APRU</th></tr>
