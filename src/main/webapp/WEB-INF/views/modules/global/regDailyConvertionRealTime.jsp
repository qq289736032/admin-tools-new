...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/global/basicOperation/regConvertionRealTime"><spring:message code='str577'/></a></li>
		<li class="active"><a href="${ctx}/global/basicOperation/regDailyConvertionRealTime"><spring:message code='str588'/></a></li>
	</ul>
	<form id="searchForm" action="${ctx}/global/basicOperation/regDailyConvertionRealTime" method="post" class="breadcrumb form-search">
		<input id="pageNo" name="pageNo" type="hidden" value="${page.pageNo}"/>
		<input id="pageSize" name="pageSize" type="hidden" value="${page.pageSize}"/>

		<label><spring:message code='str3'/> <spring:message code='str4'/></label>
		<input name="createDateStart" id="createTimeStart" maxlength="50"  value="${paramMap.createDateStart}" class="input-small required" readonly="readonly"/>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
		<tr><th><spring:message code='str56'/></th> <th><spring:message code='str14'/></th> <th><spring:message code='str580'/></th> <th><spring:message code='str581'/>Flash<spring:message code='str582'/></th><th><spring:message code='str583'/></th><th><spring:message code='str584'/></th>  <th><spring:message code='str536'/></th>
