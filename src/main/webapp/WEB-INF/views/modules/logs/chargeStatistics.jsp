...
<html>
<head>
	<title><spring:message code='str706'/></title>
...
//       });
		function page(n,s){
			$("#pageNo").val(n);
		    $("#pageSize").val(s);
		    $("#searchForm").attr("action","${ctx}/log/recharge/chargeStatistics");
		    $("#searchForm").submit();
		    return false;
		}
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/log/recharge/chargeStatistics"><spring:message code='str707'/></a></li>
        <li><a href="${ctx}/log/recharge/singleChargeStatistics"><spring:message code='str708'/></a></li>
	</ul>
    <form id="searchForm" action="${ctx}/log/recharge/chargeStatistics" method="post" class="breadcrumb form-search">
        ...
        &nbsp;<input id="btnSubmit" class="btn btn-primary" type="submit" value="<spring:message code="operation.search"/>" onclick="return page();"/>
		 ...
		 &nbsp;<input id="btnExport" class="btn btn-primary" type="button" value="<spring:message code='str5'/>" onclick="doExport('${ctx}/log/recharge/chargeExport')"/>
