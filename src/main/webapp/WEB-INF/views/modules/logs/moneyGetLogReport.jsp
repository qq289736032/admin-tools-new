...
<head>
	...
	function page(n,s){
        $("#pageNo").val(n);
        $("#pageSize").val(s);
        $("#searchForm").attr("action","${ctx}/log/moneyGetLog/moneyGetLogReport");
        $("#searchForm").submit();
        return false;
  }
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/log/moneyGetLog/moneyGetLogReport"><spring:message code='str657'/></a></li>
	</ul>
	...
	<%-- 	<label><spring:message code='str3'/> <spring:message code='str4'/></label>
		...
		<input id="btnExport" class="btn btn-primary" type="button" value="<spring:message code='str5'/>" onclick="doExport('${ctx}/log/moneyGetLog/exportXls')"/>
		</shiro:hasPermission>
	</form>
	...
	<div class="pagination">${page}</div>
	 <div class="alert">
		 ...
		 <strong>Warning!</strong> <spring:message code='str895'/>,<spring:message code='str727'/>15<spring:message code='str313'/>
	 </div>
	<script type="text/javascript">
		$(document).ready(function(){
