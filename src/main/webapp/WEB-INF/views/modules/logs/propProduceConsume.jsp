...
<html>
<head>
	<title><spring:message code='str924'/></title>
...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/log/goodsFlow/propProduce"><spring:message code='str923'/></a></li>
		<li class="active"><a href="${ctx}/log/goodsFlow/propProduceConsume"><spring:message code='str924'/></a></li>
	</ul>
	<form id="searchForm" action="${ctx}/log/goodsFlow/propProduceConsume" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
		<tr><th><spring:message code='str198'/></th><th><spring:message code='str925'/></th><th><spring:message code='str654'/></th><th><spring:message code='str930'/></th>	<th><spring:message code='str664'/></th><th><spring:message code='str931'/></th><th><spring:message code='str666'/></th>
			<th><spring:message code='str932'/></th><th><spring:message code='str669'/></th><th><spring:message code='str670'/></th></tr>
		</thead>
		<tbody>
	...
	<div class="alert alert-info">
		...
		3. <spring:message code='str674'/>VIP<spring:message code='str675'/>VIP<spring:message code='str676'/>VIP<spring:message code='str933'/>
	</div>
<script type="text/javascript">
$(document).ready(function () {
