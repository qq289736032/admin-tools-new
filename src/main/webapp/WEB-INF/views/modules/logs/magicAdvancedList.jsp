...
<html>
<head>
	<title><spring:message code='str186'/></title>
	<meta name="decorator" content="default"/>
	<%@include file="/WEB-INF/views/include/highcharts.jsp" %>
</head>
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/log/magic/magicAdvancedList">神兵进阶</a></li>
	</ul>
	<form id="searchForm" action="${ctx}/log/magic/magicAdvancedList" method="post" class="breadcrumb form-search">
	...
	<div class="row-fluid">
 		...
 		<div class="panel-heading"><spring:message code='str187'/></div>
			...
			<table id="contentTable" class="table table-striped table-bordered table-condensed">
				...
				<c:forEach items="${magicGrade}" var="item">
					<tr>
						<td>${item.level}</td>
               			<td>${item.num}</td>
					</tr>
 	...
 	<div class="row-fluid">
 		<div class="span12 panel panel-primary">
 		<div class="panel-heading"><spring:message code='str188'/></div>
			<div class="" style="width:100%;height:300px;line-height:300px;overflow:auto;overflow-x:hidden;">
			<table id="contentTable" class="table table-striped table-bordered table-condensed">
				...
				<c:forEach items="${magicStatistics }" var="item">  
