...
<html>
<head>
<title><spring:message code='str959'/></title>
<meta name="decorator" content="default" />
</head>
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/log/rank/rankStatisticsList"><spring:message code='str960'/></a></li>
	</ul>
	<form id="searchForm" action="${ctx}/log/rank/rankStatisticsList" method="post" class="breadcrumb form-search">
