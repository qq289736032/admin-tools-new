...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/log/moneyFlow/treasureProduce"><spring:message code='str1086'/></a></li>
		<li><a href="${ctx}/log/moneyFlow/treasureConsume"><spring:message code='str1087'/></a></li>
	</ul>
	<form id="searchForm" action="${ctx}/log/moneyFlow/treasureProduce" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
		<tr><th><spring:message code='str654'/></th><th><spring:message code='str1088'/></th>	<th><spring:message code='str679'/></th><th><spring:message code='str1089'/></th><th><spring:message code='str681'/></th><th><spring:message code='str682'/></th>
			<th><spring:message code='str1090'/></th><th><spring:message code='str684'/></th><th><spring:message code='str685'/></th></tr>
		</thead>
		<tbody>
