...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/log/rank/rechargeRank"><spring:message code='str975'/></a></li>
    <li class="active"><a href="${ctx}/log/rank/singleRechargeRank"><spring:message code='str976'/></a></li>
</ul>
<form id="searchForm" action="${ctx}/log/rank/singleRechargeRank" method="post" class="breadcrumb form-search">
    ...
    <input name="createDateStart" class="input-small required" readonly="readonly" value="${paramMap.createDateStart}" 
...
<form id="tableForm" action="">
    <table id="rechargeRank" class="datatable table table-striped table-bordered table-condensed">
        ...
        <th><spring:message code='str54'/></th>
        <th><spring:message code='str977'/></th>
        <th>7<spring:message code='str912'/></th>
        <th>30<spring:message code='str912'/></th>
        <th>vip<spring:message code='str85'/></th>
        <th><spring:message code='str773'/></th>
        <th><spring:message code='str774'/></th>
        <th><spring:message code='str59'/></th>
        <th><spring:message code='str60'/></th>
