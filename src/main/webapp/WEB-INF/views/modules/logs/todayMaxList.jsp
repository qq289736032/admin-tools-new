...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/log/rank/todayMax"><spring:message code='str1076'/></a></li>
		<li><a href="${ctx}/log/rank/pageWorld"><spring:message code='str1077'/>(<spring:message code='str1078'/>)</a></li>
	</ul>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page}" var="item">
			<tr>
					<td>${item.pid}</td>
					<td>${fns:getGameServer(item.area_id).getName()}</td>
	 ...
	 function page(n,s){
         ...
         if(serverIds==""){
	         ...
	         $("#searchForm").attr("action","${ctx}/log/rank/todayMax");
	         $("#searchForm").submit();
         }
