...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/log/moneyFlow/coinProduce"><spring:message code='str754'/></a></li>
		<li  class="active"><a href="${ctx}/log/moneyFlow/coinProduceConsume"><spring:message code='str755'/></a></li>
	</ul>
	<form id="searchForm" action="${ctx}/log/moneyFlow/coinProduceConsume" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
		<tr><th><spring:message code='str654'/></th><th><spring:message code='str759'/></th>	<th><spring:message code='str664'/></th><th><spring:message code='str760'/></th><th><spring:message code='str666'/></th><th><spring:message code='str666'/></th>
			<th><spring:message code='str761'/></th><th><spring:message code='str669'/></th><th><spring:message code='str670'/></th></tr>
		</thead>
		<tbody>
	...
	<div class="alert alert-info">
		...
		3. <spring:message code='str674'/>VIP<spring:message code='str675'/>VIP<spring:message code='str676'/>VIP<spring:message code='str762'/>
	</div>
