...
<body>
	<ul class="nav nav-tabs">
	    ...
	    <li class="active"><a href="${ctx}/log/realTimeService/realFenTime"><spring:message code='str963'/></a></li>
	    
	</ul>
	<form id="searchForm" action="${ctx}/log/realTimeService/realFenTime" method="post" class="breadcrumb form-search">
