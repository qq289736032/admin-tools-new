...
<html>
<head>
	<title><spring:message code='str908'/></title>
	<meta name="decorator" content="default"/>
	<%@include file="/WEB-INF/views/include/highcharts.jsp" %>
</head>
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/log/rank/power"><spring:message code='str908'/></a></li>
		<li><a href="${ctx}/log/rank/singlePower"><spring:message code='str909'/></a></li>
	</ul>
	<form id="searchForm" action="${ctx}/log/rank/power" method="post" class="breadcrumb form-search">
