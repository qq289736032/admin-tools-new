...
<ul class="nav nav-tabs">
    <li class="active"><a href="${ctx}/log/rank/consumeRank"><spring:message code='str766'/></a></li>
    <li><a href="${ctx}/log/rank/singleConsumeRank"><spring:message code='str767'/></a></li>
</ul>
<form id="searchForm" action="${ctx}/log/rank/consumeRank" method="post" class="breadcrumb form-search">
