...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/log/userStat/churnUser"><spring:message code='str720'/></a></li>
        <li class="active"><a href="${ctx}/log/userStat/churnUserLevel"><spring:message code='str721'/></a></li>
	</ul>
    <form id="searchForm" action="${ctx}/log/userStat/churnUserLevel" method="post" class="breadcrumb form-search">
    ...
    <form id="tableForm" action="">
        ...
        <div class="panel panel-primary">
            <div class="panel-heading"><spring:message code='str722'/></div>
            <table id="contentTable" class="table table-striped table-bordered table-condensed">
                <input type="text" style="display: none" hidden="hidden" name="msg" id="msg">
                <tr>
                    <th><spring:message code='str723'/></th><th><spring:message code='str724'/></th><th><spring:message code='str226'/></th><th><spring:message code='str725'/></th><th><spring:message code='str226'/></th><th><spring:message code='str726'/></th><th><spring:message code='str226'/></th>
                </tr>
        ...
        <%--<div class="alert alert-error">--%>
            ...
            <%--<strong>Warning!</strong><spring:message code='str727'/>7<spring:message code='str728'/>--%>
        <%--</div>--%>
        <%--<div class="alert alert-info">--%>
            ...
            <%--4. <spring:message code='str736'/>/<spring:message code='str737'/>14<spring:message code='str738'/>7<spring:message code='str739'/>--%>
