...
<html>
<head>
	<title><spring:message code='str1085'/></title>
...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/log/moneyFlow/treasureProduce"><spring:message code='str1086'/></a></li>
		<li class="active"><a href="${ctx}/log/moneyFlow/treasureConsume"><spring:message code='str1087'/></a></li>
	</ul>
	<form id="searchForm" action="${ctx}/log/moneyFlow/treasureConsume" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
		<tr><th><spring:message code='str654'/></th><th><spring:message code='str1641'/></th>	<th><spring:message code='str1642'/></th><th><spring:message code='str1643'/></th><th><spring:message code='str1644'/></th><th><spring:message code='str1645'/></th>
			<th><spring:message code='str1646'/></th><th><spring:message code='str1647'/></th><th><spring:message code='str1648'/></th></tr>
		</thead>
		<tbody>
	...
	<div class="alert alert-info">
		...
		3. <spring:message code='str674'/>VIP<spring:message code='str675'/>VIP<spring:message code='str676'/>VIP<spring:message code='str1091'/>
	</div>
