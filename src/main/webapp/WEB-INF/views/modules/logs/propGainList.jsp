...
<head>
	<title><spring:message code='str922'/></title>
...
<body>
     <ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/log/propController/propGainList"><spring:message code='str922'/></a></li>
	 </ul>
	<form id="searchForm" action="${ctx}/log/propController/propGainList" method="post" class="breadcrumb form-search">
	    ...
	    &nbsp;<input id="btnExport" class="btn btn-primary" type="button" value="<spring:message code='str5'/>" onclick="doExport('${ctx}/log/propController/gainExport')"/>
		</shiro:hasPermission>
	</form>
