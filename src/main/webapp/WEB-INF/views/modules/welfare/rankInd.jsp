...
<script type="text/javascript"
	src="${ctxStatic}/modules/welfare/rank.js?timestamp=1113"></script>
<script type="text/javascript"
...
<body>
	...
	<div style="margin: 20px">
		<ul class="nav nav-tabs">
			<li class="active"><a href="${ctx}/welfare/goldPool/indIssueRank">发放排名</a></li>
	...
	<script type="text/javascript">
		function initTable(url) {
			$('#rankPlatTable').bootstrapTable('destroy').bootstrapTable({
				...
				showExport : "true",
				exportDataType : "all",
				responseHandler : "dealRankIndData",
				/* sortable : true,
				sortName:"sumYb",
				sortType:"desc", */
...

				{
					...
					field : 'tradingTimes',
					title : '<font color="red">周交易<br/>元宝/次数</font>',
					sortable : "true",
					align : "center"
				},{
					field : 'marketTimes',
					title : '<font color="red">周市场交易<br/>元宝/次数</font>',
					sortable : "true",
					align : "center"
				} ,{
					field : 'sumCharge',
