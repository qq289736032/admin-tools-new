...
<script type="text/javascript">
	...
	$(function() {
		...
		initTable(BASE + "/welfare/goldPool/grantGoldLogData?pid="
...
<body>
	...
	<div style="margin: 20px">
		<ul class="nav nav-tabs">
			<li class="active"><a href="${ctx}/welfare/goldPool/platGoldPoolLog">操作日志</a></li>
				...
				<div class="span12">
					<div style="margin-left: 20px;">
						...
						<div class="form-group">
							...
							<input type="text" name="startTimeStart" class="input_search"
								size="10" readonly="readonly" maxlength="20" value=""
								id="startDatePicker"
			...
			<div class="row-fluid">
				<div class="span12">
					<div style="margin-left: 20px;">
						...
						<div class="form-group">
							<label for="name">平台:</label> <select id="platSel2"></select> <label
								for="name" style="margin-left: 20px">服务器:</label> <select
								id="serverSelect2"></select> <label for="name"
								style="margin-left: 20px">角色名:</label> <input id="roleName2" />
							<label for="name" style="margin-left: 20px">平台账号:</label> <input
								id="userId2" /> <label for="name" style="margin-left: 20px">操作时间:</label>
							<input type="text" name="startTimeStart" class="input_search"
								size="10" readonly="readonly" maxlength="20" value=""
								id="startDatePicker"
								onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'endDatePicker\')}'})">
							...
							<div class="btn-group" style="margin-left: 20px">
								<button type="button" class="btn btn-primary "
									data-toggle="modal" onclick="search()">
									<span class="glyphicon glyphicon glyphicon-search"></span> 查 询
								</button>
								<button type="button" class="btn btn-primary " id="dc">
