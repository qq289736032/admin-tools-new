...
<html>
<head>
<title>福利奖金池(独代)</title>
<meta name="decorator" content="default" />

<script type="text/javascript">
	var passageway = "独代通道";
	var goldPoolCategory = "独代奖金池";
	$(function() {
...
<body>
	...
	<div style="margin: 20px">
		<ul class="nav nav-tabs">
			<li class="active"><a href="${ctx}/welfare/goldPool/indGoldPool">福利奖金池</a></li>
			...
			<div class="row-fluid">
				<div class="span6">
					<form class="form-horizontal">
						...
						<div class="control-group">
							<div class="controls">
								<button type="button" class="btn btn-primary " data-loading-text="正在发放" id="grant" data-toggle="modal" onclick="grantGold()">
		...
		<p  style="color: red">说明：</p>
			...
			<ul class="unstyled"  style="color: red">
