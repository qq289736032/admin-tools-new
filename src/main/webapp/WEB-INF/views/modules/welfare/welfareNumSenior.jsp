...
<script type="text/javascript">
	...
	$(function() {
		...
		//隐藏全选框
		$("input[name='btSelectAll']").attr("type","hidden");
	});
</script>
...
<body>
	...
	<div style="margin: 20px">
		<ul class="nav nav-tabs">
			<li class="active"><a href="${ctx}/welfare/num/numSenior">福利号高级管理</a></li>
	...
	<div class="row-fluid">
		<div class="span12">
			<div class="form-actions" style="background-color: #FFB6C1;margin:0 auto;">
             	操作 <span style="margin-left: 30px">特殊通道</span> <input type="text" id="goldNum" style="width: 60px"/>元宝 <button type="button" data-loading-text="正在发放" class="btn" id="grant" data-toggle="modal" onclick="grantGold()">
			 ...
			 <label for="name" >平台:</label>
			   ...
			   <label for="name" style="margin-left: 20px" >平台账号:</label>
			    ...
			    <div class="btn-group" style="margin-left: 20px" >
		       	...
		       	<button type="button" class="btn btn-danger" data-toggle="modal" onclick="deleteNum()">
