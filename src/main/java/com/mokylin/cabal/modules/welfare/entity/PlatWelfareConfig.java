 ...
 * 福利配置通用模板
 */
public class PlatWelfareConfig extends MybatisBaseBean{
	public static String GOLD_POOL_CATEGORY_PLAT = "平台奖金池";
	public static String GOLD_POOL_CATEGORY_INDEPEND = "独代奖金池";
	public static final int STATUS_NORMAL = 0;//正常
	public static final int STATUS_STOP = 1;//暂停
	private static final long serialVersionUID = 1L;
	private String id;
	private String pid;
	private String platName;//平台名
	private String platNature;//平台性质
	private String goldPoolCategory;//奖金池分类
